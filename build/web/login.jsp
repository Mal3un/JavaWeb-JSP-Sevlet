<%-- 
    Document   : login
    Created on : May 8, 2022, 1:18:19 PM
    Author     : admin
--%>
                ...
                <form id="form2" >
                    <div class="login">
                        ...
                        <div class="login-body ">
                            <input id="username" type="text" placeholder="username" class="login-id">
                            <small></small>
                            <span></span>
                        </div>                  
                        <div class="login-body">
                            <input id="password" type="password" placeholder="password" class="login-id">
                            <small></small>
                            <span></span>
                        </div>
                        
                        <span style="color:red;padding:24px 0px 0px ;font-size:14px;text-align:center;display: block;" id="thongbao">
                            
                        </span>
                        <a href="#" class="login-button-link" >
                            <button style="display:block;" type="submit" class="login-button">                        
                                Login
                            </button>                   
                        </a>
...
<!--                <a class="ads hide-on-mobile-tablet">
                    
                     <button class="back-ads">    
                        <i class="fa-solid fa-angle-left"></i>             
                    </button> 
                    
                        <img src="../assets/img/quangcao-login-1.png" alt=""
                        class="ads-img">
                        <img src="../assets/img/quangcao-login-2.png" alt=""
                        class="ads-img">
                    
                
                                  
                     <button class="next-ads">
