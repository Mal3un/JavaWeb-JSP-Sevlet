    ...
    <div class="main">
        ...
        <div class="container">
                ...
                <div class="grid wide">
                    <div class="container1-menu row no-gutters ">
                        <div class="col l-1 m-2 c-2">
                            <a href="" class="container1-home-btn ">
            ...
            <div class="container2">
                <div class="grid wide">
                    <div class="container2-menu row no-gutter">
                        <div class="col l-12 m-12 c-12">

                            <a href="" class="container2-menu-link">
                                <img src="./assets/img/slide-7-pka.png" alt="" class="container2-menu-background">
                            </a>
                        </div>
                        <div class="col l-12 m-12 c-12">
                            <h2 class="container2-menu-title">Các chính sách ưu đãi</h2>
                        </div>
                        <div class="col l-3 m-6 c-6 ">
                            <div class="container2-menu-promotion">
                                <img src="https://theme.hstatic.net/1000233206/1000806987/14/home_promotion_1_imec.png?v=318"
                                    alt="" class="container2-menu-promotion-img">
                            </div>
                        </div>
                        <div class="col l-3 m-6 c-6 ">
                            <div class="container2-menu-promotion">
                                <img src="https://theme.hstatic.net/1000233206/1000806987/14/home_promotion_2_imec.png?v=325"
                                    alt="" class="container2-menu-promotion-img">
                            </div>
                        </div>
                        <div class="col l-3 m-6 c-6 ">
                            <div class="container2-menu-promotion">
                                <img src="https://theme.hstatic.net/1000233206/1000806987/14/home_promotion_3_imec.png?v=325"
                                    alt="" class="container2-menu-promotion-img">
                            </div>
                        </div>
                        <div class="col l-3 m-6 c-6 ">
                            <div class="container2-menu-promotion">
                                <img src="https://theme.hstatic.net/1000233206/1000806987/14/home_promotion_4_imec.png?v=325"
                                    alt="" class="container2-menu-promotion-img">
                            </div>
                        </div>
                    </div>
            ...
            <div class="grid wide">
                ...
                <div class="product-sale">
                    <div class="product-sale-title row sm-gutter">
                        <div class="col l-12 m-12 c-12">
                            <h1 class="product-sale-title-heading">Laptop Gaming</h1>
                        </div>
                    </div>
                    <div class="product-sale-list row sm-gutter">
                    <jsp:useBean id="laptop" class="loaddata.DAO" scope="request"></jsp:useBean>
                    <c:forEach items="${laptop.allproductIndex1}" var ="i">
                    ...
                    <a href="laptop.jsp" class="product-sale-more row sm-gutter">
                        <div class="col l-12 m-12 c-12">
                            <h1 class="product-sale-more-heading">Xem thêm các sản phẩm Laptop Gaming</h1>
                        </div>
                    </a>
                </div>
                <a href="" class="product-banner">
                    <img src="assets/img/quangcao2.jpg.png" alt="" class="product-banner1">
                </a>
                <div class="product-sale">
                    <div class="product-sale-title row sm-gutter">
                        <div class="col l-12 m-12 c-12">
                    ...
                    <c:forEach items="${gamingGear.allproductIndex2}" var ="i">
                        <a style="text-decoration: none;" href="product?pid=${i.id}" class="col l-2-4 m-4 c-6">
                            <div class="sale-product-item">
                                <img class="sale-product-img" src="${i.img}" alt="" >                               
                                <div class="sale-product-item-body">
                    ...
                    <a href="gamingGear.jsp" class="product-sale-more row sm-gutter">
                        <div class="col l-12 m-12 c-12">
                            <h1 class="product-sale-more-heading">Xem thêm các sản phẩm Gaming Gear</h1>
                        </div>
                    </a>
                </div>    
            </div>
