                                                ...
                                                <li class="product-item">
                                                    ...
                                                    <div class="product-item-info">
                                                        ...
                                                        <div class="product-item-body">
                                                            ...
                                                            <a style="text-decoration: none;" href="deletecartByuser?&url=laptop.jsp&uid=${acc.id}&pid=${j.id}" class="product-item-remove">Xóa</a>
                                                        </div>
                                                    </div>
                                                </li>
                                            </c:forEach>
            ...
            <div class="grid wide">
                ...
                <div class="product-sale">
                    ...
                    <div class="product-sale-list row sm-gutter">                     
                        ...
                        <c:forEach items="${laptop.allproduct1}" var ="i">
