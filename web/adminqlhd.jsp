            ...
            <table border="collapse" width="100%" cellspacing>
                <tr height="50px">
                    ...
                    <c:if test="${SearchingBill == null}" >
                        ...
                        <c:forEach items="${a.allbillStatus0}" var ="i">
                            <tr>
                                <td>${i.id}</td>
                                <td>${i.idKh}</td>
                                ...
                                <td>
                                    <a href="ConfirmOrder?ma=${i.id}" class="btn_sua">
                                        Duyệt
                                    </a>             
                                </td>
                                <td>
                                    <a class ="btn_xoa" href="DeleteBill?bid=${i.id}&url=adminqlhd.jsp">
                                        Xóa
                                    </a>             
                                </td>
                            </tr>
